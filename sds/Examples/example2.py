...
hands = {'N': ['C14', 'C13', 'C12'], 'E': ['S14', 'S13', 'H12', 'H13'], 
    'S': ['D14', 'D11', 'H14', 'H11'], 'W': ['D12', 'S12', 'S11']}
...
# has the right amount of cards given a trick is incomplete
current_trick = [('W', 'D13'), ('N', 'C11')]
